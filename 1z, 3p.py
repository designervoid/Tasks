...
def grad_x(x1, y1):
    return x1*(np.sin(np.sqrt(x1**2 + y1**2))**2 - 0.5)/(500*(x1**2/1000 + y1**2/1000 + 1)**2) \
           - 2*x1*np.sin(np.sqrt(x1**2 + y1**2))* \
           np.cos(np.sqrt(x1**2 + y1**2))\
           /(np.sqrt(x1**2 + y1**2)*(x1**2/1000 + y1**2/1000 + 1))
def grad_y(x2, y2):
    return y2*(np.sin(np.sqrt(x2**2 + y2**2))**2 - 0.5)/(500*(x2**2/1000 + y2**2/1000 + 1)**2) \
           - 2*y2*np.sin(np.sqrt(x2**2 + y2**2))* \
           np.cos(np.sqrt(x2**2 + y2**2))\
           /(np.sqrt(x2**2 + y2**2)*(x2**2/1000 + y2**2/1000 + 1))
